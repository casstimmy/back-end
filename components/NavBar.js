...
import { faStore, faRightFromBracket, faBell, faBars } from "@fortawesome/free-solid-svg-icons";
...
<div className="fixed top-0 w-full z-50 flex justify-between items-center py-3 px-4 sm:px-6 bg-gradient-to-r from-[#FAF8F5] to-[#FFFDF9] shadow-sm border-b border-[#E6E1DA]">
      ...
      <div className="flex items-center space-x-2 sm:space-x-6">
        <button className="relative">
          <FontAwesomeIcon icon={faBell} className="w-6 h-6 text-gray-600 hover:text-amber-600 transition" />
          <span className="w-2.5 h-2.5 bg-amber-500 rounded-full absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 shadow-sm"></span>
        </button>
