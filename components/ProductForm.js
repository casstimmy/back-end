...
export default function ProductForm(props) {
  ...
  async function saveProduct(e) {
    ...
    const data = {
      ...
      quantity: quantity ? parseInt(quantity) : undefined, // Optional: set if provided
    };
      ...
      <Section title="Pricing">
        ...
        <div className="mt-4 p-4 bg-gray-50 border rounded-lg">
          <p className="text-sm text-gray-700">
            <span className="font-semibold">Profit:</span> {formatCurrency(profit)}
          </p>
          <p className="text-sm text-gray-700">
            <span className="font-semibold">Margin:</span> {formatNumber(calcMargin)}%
          </p>
        </div>
      </Section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              {promoPrice && (
                ...
                >
                  Promo Margin: {formatNumber(promoMargin)}%{" "}
